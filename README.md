...
REESTRUCTURA_BD:
 ...
 - proy
  ...
  - Checkbox de "existente" al final de ppto, si click carga un ddl con los pptos de esa obra y en vez de crear un nuevo valor edito el proc seleccionado. En el de proy bloqueo la categor�a y cargo la del proc seleccionado.
