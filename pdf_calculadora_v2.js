...
function generaReporteCalculadora(obra_ppto, ){
    ...
    var totales={costo:'$50000', utilidad: '$5000', cliente:'$55000'};
    var indirectos={porcentaje: '10%', costo:'$5000'};
    var operaciones={utilidad: '10%', costo:'$55000'};
    var utilidad={utilidad: '10%', cliente:'$60500'};
    var logo = {
