...
function generaReporteCalculadora(obra_ppto, score){
    ...
    var indirectos={porcentaje: '10%', costo:'$5000'};
...
// =============================================================================
    ...
    var bod0 = [
      [{border: [false, false, false, false],text:'', margin:[5,10],},{border: [false, false, false, false],text:''},{border: [false, false, false, false],text:''},{border: [false, false, false, false],text:''},{border: [false, false, false, false],text:''},{border: [false, false, false, false],text:''}],
      [
    ...
    var body = bod0.concat(bod1).concat(bod2).concat(bod3).concat(bod4).concat(bod5);
    var cont =  [
        //Header
        {
            table:{
    ...
    var pdfPresupuesto = {
        ...
        footer: function(currentPage,pageCount) {
            return { fontSize:8,alignment: 'center', text:'Este documento carece de validez oficial y es solo para uso interno de la empresa. Queda prohibida su divulgación.'};
        },
